...
#include "..\Platform\LPC17xx\lpc17xx_ssp.h"
#include "..\Platform\LPC17xx\lpc17xx_gpio.h"
#include "..\Platform\LPC17xx\lpc17xx_pinsel.h"
...
/* PORT number that SD_PWR pin assigned on */
#define SD_PWR_PORT_NUM		3
/* PIN number that  SD_PWR pin assigned on */
#define SD_PWR_PIN_NUM		26
/* PORT number that SD_CD pin assigned on */
#define SD_CD_PORT_NUM		3
...
#define _card_power_on()		GPIO_ClearValue(SD_PWR_PORT_NUM, (1<<SD_PWR_PIN_NUM))  	
